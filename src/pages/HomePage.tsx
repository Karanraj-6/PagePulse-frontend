...
const BookCard = ({ book }) => {
    return (
        <div className="group relative h-[450px] w-full bg-[#111]/90 border border-white/5 rounded-2xl overflow-hidden hover:border-[#d4af37]/40 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,1)] flex flex-col backdrop-blur-sm cursor-pointer">
