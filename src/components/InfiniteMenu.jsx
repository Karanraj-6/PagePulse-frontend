...
class InfiniteGridMenu {
  ...
  targetItemIndex = null; // New: For programmatic scrolling
  ...
  // New: Method to scroll to a specific item index
  scrollTo(index) {
    ...
    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
      ...
      {activeItem && (
        <>
          ...
          <div onClick={(e) => { e.stopPropagation(); handleNavigation(); }} className={`action-button ${isMoving ? 'inactive' : 'active'}`}>
